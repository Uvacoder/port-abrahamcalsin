...
const logoModifiedDarkMode = document.getElementById('logoModifiedDarkMode')
...
const applyTheme = isDark => {
  if (isDark) {
    ...
    logoModifiedDarkMode.setAttribute(
      'src',
      '../resources/img-logotype/logo-abraham-calsin-white.svg',
    )
  } else {
    ...
    logoModifiedDarkMode.setAttribute(
      'src',
      '../resources/img-logotype/logo-abraham-calsin-black.svg',
    )
  }
}
