...
const ContactSocialMedia = (props) => {
  ...
  return (
    <li className={clsx("flex items-center my-0.7 sm:text-xsm-1.2 text-sm")}>
      <img src={iconSocialSrc} className={clsx("w-2.2 sm:w-2.5")} alt={alt} />
      <span className={clsx("font-extraBold sm:mx-1")}>{contentSpan}</span>
...
const AboutMe = () => {
  return (
    <MainLayout>
      ...
      <div className="mt-0 sm:mt-7.5 sm:mb-3.7">
