    ...
    <MainLayout>
      ...
      <div className="mt-0 sm:mt-20 sm:mb-10">
        ...
        <p className="text-size-4 leading-loose font-medium mt-2 px-0 sm:text-size-8.1-desk">
          Hey, hola! Soy Abraham Calsin un individuo autodidacta, me apasiona el diseño y la programación web, actualmente me desempeño como Maquetador Web, creo proyectos de código
